...
public class AssignmentLocalServiceImpl extends AssignmentLocalServiceBaseImpl {
	...
	public Assignment addAssignment(long groupId, Map<Locale, String> titleMap, String description, Date dueDate,
		...
		/*
		 * ( 1 ) - Get group. Group is used for the scoping the Assignment entity for
		 * the site.
		 */
		Group group = groupPersistence.findByPrimaryKey(groupId);

		/*
		 * ( 2 ) - Get user. Hint: get the userId from the ServiceContext
		 */
		...
		/*
		 * ( 4 ) - Create a new assignment object. Hint: use the available method from
		 * superclass
		 */
	...
	public List<Assignment> getAssignmentsByGroupId(long groupId) {
		...
		return assignmentPersistence.findByGroudId(groupId);
	}

	public List<Assignment> getAssignmentsByGroupId(long groupId, int start, int end) {

		return assignmentPersistence.findByGroudId(groupId, start, end);
	}

	public int getAssignmentsCountByGroupId(long groupId) {

		return assignmentPersistence.countByGroudId(groupId);
	}
