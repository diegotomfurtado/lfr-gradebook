...
public class AssignmentUtil {
	 ...
	 * @return the matching assignments
	 */
	public static List<Assignment> findByGroudId(long groupId) {
		return getPersistence().findByGroudId(groupId);
	}
	 ...
	 * @return the range of matching assignments
	 */
	public static List<Assignment> findByGroudId(
		long groupId, int start, int end) {

		return getPersistence().findByGroudId(groupId, start, end);
	}
	...
	public static List<Assignment> findByGroudId(
		...
		return getPersistence().findByGroudId(
	 ...
	 * @throws NoSuchAssignmentException if a matching assignment could not be found
	 */
	public static Assignment findByGroudId_First(
			long groupId, OrderByComparator<Assignment> orderByComparator)
		throws com.liferay.training.gradebook.exception.
			NoSuchAssignmentException {

		return getPersistence().findByGroudId_First(groupId, orderByComparator);
	}
	 ...
	 * @return the first matching assignment, or <code>null</code> if a matching assignment could not be found
	 */
	public static Assignment fetchByGroudId_First(
		long groupId, OrderByComparator<Assignment> orderByComparator) {

		return getPersistence().fetchByGroudId_First(
	 ...
	 * @throws NoSuchAssignmentException if a matching assignment could not be found
	 */
	public static Assignment findByGroudId_Last(
			long groupId, OrderByComparator<Assignment> orderByComparator)
		throws com.liferay.training.gradebook.exception.
			NoSuchAssignmentException {

		return getPersistence().findByGroudId_Last(groupId, orderByComparator);
	}
	 ...
	 * @return the last matching assignment, or <code>null</code> if a matching assignment could not be found
	 */
	public static Assignment fetchByGroudId_Last(
		long groupId, OrderByComparator<Assignment> orderByComparator) {

		return getPersistence().fetchByGroudId_Last(groupId, orderByComparator);
	}
	 ...
	 * @throws NoSuchAssignmentException if a assignment with the primary key could not be found
	 */
	public static Assignment[] findByGroudId_PrevAndNext(
			long assignmentId, long groupId,
			OrderByComparator<Assignment> orderByComparator)
		throws com.liferay.training.gradebook.exception.
			NoSuchAssignmentException {

		return getPersistence().findByGroudId_PrevAndNext(
	 ...
	 * @param groupId the group ID
	 */
	public static void removeByGroudId(long groupId) {
		getPersistence().removeByGroudId(groupId);
	}
	 ...
	 * @return the number of matching assignments
	 */
	public static int countByGroudId(long groupId) {
		return getPersistence().countByGroudId(groupId);
	}

	/**
	 * Returns the assignment where status = &#63; or throws a <code>NoSuchAssignmentException</code> if it could not be found.
	 *
	 * @param status the status
	 * @return the matching assignment
	 * @throws NoSuchAssignmentException if a matching assignment could not be found
	 */
	public static Assignment findByStatus(int status)
		throws com.liferay.training.gradebook.exception.
			NoSuchAssignmentException {
	...
	/**
	 * Returns the assignment where status = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param status the status
	 * @return the matching assignment, or <code>null</code> if a matching assignment could not be found
	 */
	public static Assignment fetchByStatus(int status) {
		return getPersistence().fetchByStatus(status);
	}

	/**
	 * Returns the assignment where status = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param status the status
	 * @param retrieveFromCache whether to retrieve from the finder cache
	 * @return the matching assignment, or <code>null</code> if a matching assignment could not be found
	 */
	public static Assignment fetchByStatus(
	...
	/**
	 * Removes the assignment where status = &#63; from the database.
	 *
	 * @param status the status
	 * @return the assignment that was removed
	 */
	public static Assignment removeByStatus(int status)
		throws com.liferay.training.gradebook.exception.
			NoSuchAssignmentException {
